    ...
    <div className="bg-background">
      <div className="container mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="prose dark:prose-invert max-w-none">
          ...
          <p>
            CreatorX SEO ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how
            we collect, use, disclose, and safeguard your information when you use our website and services (collectively,
            the "Services"). Please read this privacy policy carefully. If you do not agree with the terms of this privacy
          ...
          <h3>Personal Data</h3>
          <p>
            Personally identifiable information, such as your name, email address, that you voluntarily give to us when you
            register with the Services. You are under no obligation to provide us with personal information of any kind,
            however your refusal to do so may prevent you from using certain features of the Services.
          </p>
          
          <h3>Firebase Authentication</h3>
          <p>
            We use Firebase Authentication to manage user sign-up and login. When you create an account, Firebase
            collects authentication information, such as your email address and password. This data is stored securely by
            Google.
          </p>
